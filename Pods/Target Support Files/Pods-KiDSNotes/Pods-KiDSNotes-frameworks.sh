...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/ParseCrashReporting/ParseCrashReporting.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/TWPhotoPicker/TWPhotoPicker.framework"
  install_framework "$BUILT_PRODUCTS_DIR/UIImageEffects/UIImageEffects.framework"
  install_framework "$BUILT_PRODUCTS_DIR/UIScrollSlidingPages/UIScrollSlidingPages.framework"
fi
