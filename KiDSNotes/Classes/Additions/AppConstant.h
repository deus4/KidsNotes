...
#define		PF_USER_FULLNAME					@"displayName"				//	String
#define		PF_USER_FULLNAME_LOWER				@"displayName"		//	String
#define		PF_USER_TWITTERID					@"twitterId"			//	String
#define		PF_USER_FACEBOOKID					@"facebookId"			//	String
#define		PF_USER_PICTURE						@"profilePictureMedium"				//	File
#define		PF_USER_THUMBNAIL					@"profilePictureMedium"			//	File
//-----------------------------------------------------------------------
