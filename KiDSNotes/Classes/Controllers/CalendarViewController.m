...
- (void)viewDidLoad {
    ...
    _calendarManager.dateHelper.calendar.locale = [NSLocale localeWithLocaleIdentifier:@"ru"];
...
- (UIView *)calendarBuildMenuItemView:(JTCalendarManager *)calendar
{
    ...
    label.font = [UIFont fontWithName:@"PFKidsPro-GradeOne" size:16];
...
- (UIView<JTCalendarDay> *)calendarBuildDayView:(JTCalendarManager *)calendar
{
    ...
    view.textLabel.font = [UIFont fontWithName:@"PFKidsPro-GradeOne" size:13];
...
- (UIView<JTCalendarWeekDay> *)calendarBuildWeekDayView:(JTCalendarManager *)calendar
{
    ...
    for(UILabel *label in view.dayViews){
        ...
        label.font = [UIFont fontWithName:@"PFKidsPro-GradeOne" size:13];
    }
