...
@property (strong, nonatomic) IBOutlet UILabel *cameraTextLabel;
...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self.cameraTextLabel setKidsProGradeFiveFont];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([[segue identifier] isEqualToString:@"makePhoto"])
    {
    ...
    dispatch_async( self.sessionQueue, ^{
        ...
        [self.stillImageOutput captureStillImageAsynchronouslyFromConnection:connection completionHandler:^( CMSampleBufferRef imageDataSampleBuffer, NSError *error ) {
            if ( imageDataSampleBuffer ) {
                ...
                [self performSegueWithIdentifier:@"makePhoto" sender:self];
